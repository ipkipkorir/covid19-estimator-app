...
def estimator(data):
	...
	impactHospitalBedsByRequestedTime = math.trunc(((0.35 * data['totalHospitalBeds']) - impactSevereCasesByRequestedTime) // 1)
	...
	severeImpactHospitalBedsByRequestedTime = math.trunc(((0.35 * data['totalHospitalBeds']) - severeImpactSevereCasesByRequestedTime) // 1)
